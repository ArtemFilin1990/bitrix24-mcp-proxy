...
import { BadRequestError, ensurePositiveNumber, ensureObject, ensureNumber, ensureArray, ensureBoolean } from '../validation.js';
...
export const leadTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    parameters: {
      fields: {
        type: 'object',
        description: 'Поля лида (обязательно TITLE)',
      },
    },
  },
  {
...
export const buildLeadRequest = (toolName: string, args: Record<string, unknown>) => {
  switch (toolName) {
